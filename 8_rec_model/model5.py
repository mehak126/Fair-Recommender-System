# Most ideal case - allot exposure to aspects acc to preferences. what about items :// -> doing equal
# Inputs
...
def main():
	...
	#Elisa Algo with twist -> to be removed
	print("\n\n")
