...
def main():
	...
	data1 = pandas.read_csv('fp_data_jja.csv', low_memory=False).as_matrix()

	with open('item_asp_map_fp_true.pickle', 'rb') as handle:
		item_asp = pickle.load(handle)

	with open('fp_items.pickle', 'rb') as handle: #item_id -> index
