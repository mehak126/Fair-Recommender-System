...
def main():
	...
	data1 = pandas.read_csv('ors_data_jja.csv', low_memory=False).as_matrix()

	with open('item_asp_map_ors.pickle', 'rb') as handle:
		item_asp = pickle.load(handle)

	with open('ors_items.pickle', 'rb') as handle: #item_id -> index
		ors = pickle.load(handle)
